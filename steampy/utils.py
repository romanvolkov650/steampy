...
def calculate_gross_price(
    price_net: Decimal, publisher_fee: Decimal, steam_fee: Decimal = Decimal("0.05")
) -> Decimal:
...
def calculate_net_price(
    price_gross: Decimal, publisher_fee: Decimal, steam_fee: Decimal = Decimal("0.05")
) -> Decimal:
...
def get_sell_listings_from_node(node: Tag, existing_listings: set[int] = None) -> dict:
